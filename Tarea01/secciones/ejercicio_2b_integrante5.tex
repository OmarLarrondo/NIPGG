...
%  Responsable: [Quinto integrante - por definir]
%
%  NOTA: Este ensayo es INDIVIDUAL, uno por cada integrante del equipo.
%  Cuando se sume el quinto integrante, renombre este archivo con su apellido
%  (p. ej. ejercicio_2b_<apellido>.tex) y actualice el nombre en el titulo y
%  la ruta en main.tex.
% =========================================================================

\subsection*{Ensayo individual — [Quinto integrante]}
